...
<head>
    ...
    <link href="{{ asset('admin/css/taginput.css') }}" rel="stylesheet" type="text/css">
    <link
            ...
            <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
                ...
                @if ($role->id == 3)
                    <li class="nav-item">
                        ...
                        <div id="collapsePosts" class="collapse" aria-labelledby="headingPages"
                ...
                @if ($role->id == 1 || $role->id == 2)
                    ...
                    <li class="nav-item">
                        ...
                        <div id="collapseComments" class="collapse" aria-labelledby="headingPages"
                            data-parent="#accordionSidebar">
                            <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <li class="nav-item">
                        ...
                        <div id="collapseRoles" class="collapse" aria-labelledby="headingPages"
                            ...
                            <div class="bg-white py-2 collapse-inner rounded">
                                ...
                                <a class="collapse-item" href="{{ route('permissions.index') }}">Danh sách quyền chi
                                    tiết</a>
                                <div class="collapse-divider"></div>
                            </div>
                    </li>
                ...
                @if ($role->id == 1 || $role->id == 2)
                    <li class="nav-item">
                        ...
                        <div id="collapseContacts" class="collapse" aria-labelledby="headingPages"
                            data-parent="#accordionSidebar">
                            <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                @if (Str::substr(Auth::user()->username, 5, 8) == 'facebook' || Str::substr(Auth::user()->username, 5, 6) == 'google')
                                    <img class="img-profile rounded-circle" src="{{ Auth::user()->thumbnail }}">
                                @else
