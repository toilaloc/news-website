...
<head>
    <!-- Title -->
    <title>Lỗi 401 - Bạn không có quyền truy cập</title>
    ...
    <div class="d-lg-flex">
        <div class="container d-lg-flex align-items-lg-center min-vh-lg-100 space-4">
            <div class="w-lg-60 w-xl-50">
                <!-- Title -->
                <div class="mb-4">
                    <img class="max-w-23rem mb-3" src="{{asset('frontend/assets/svg/illustrations/error-number-401.svg')}}" alt="SVG Illustration">
                    <p class="lead">Cảnh báo. Bạn không có quyền truy cập trang này.</a></p>
                </div>
                <!-- End Title -->
