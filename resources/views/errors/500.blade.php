...
<body class="bg-img-hero-fixed" style="background-image: url({{asset('frontend/assets/svg/illustrations/error-500.svg')}});">
<!-- ========== HEADER ========== -->
        ...
        <div class="container d-lg-flex align-items-lg-center min-vh-lg-100 space-4">
            <div class="w-lg-60 w-xl-50">
                ...
                <div class="mb-4">
                    ...
                    <p class="lead">Trang bạn đang truy cập không được tìm thấy, hoặc đã bị xóa. Vui lòng quay lại trang chủ.</a></p>
                </div>
                <!-- End Title -->
