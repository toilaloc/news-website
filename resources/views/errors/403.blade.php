...
<head>
    <!-- Title -->
    <title>Lỗi 403 - Bạn không có quyền truy cập hoặc đã bị chặn truy cập</title>
    ...
    <div class="header-section">
        <div id="logoAndNav" class="container">
            ...
            <a class="navbar-brand" href="{{route('home')}}" aria-label="Front">
                    <img src="{{asset('frontend/assets/svg/logos/logo.svg')}}" width="100" height="100" alt="Logo">
                </a>
            </nav>
        </div>
    </div>
    ...
    <div class="d-lg-flex">
        <div class="container d-lg-flex align-items-lg-center min-vh-lg-100 space-4">
            <div class="w-lg-60 w-xl-50">
                <!-- Title -->
                <div class="mb-4">
                    <img class="max-w-23rem mb-3" src="{{asset('frontend/assets/svg/illustrations/error-number-403.svg')}}" alt="SVG Illustration">
                    <p class="lead">Bạn không có quyền truy cập hoặc đã bị chặn khỏi trang web này.</a></p>
                </div>
                <!-- End Title -->

            <a class="btn btn-wide btn-primary transition-3d-hover" href="{{route('home')}}">Về trang chủ</a>
            </div>
        </div>
    </div>
    <!-- End Hero Section -->
