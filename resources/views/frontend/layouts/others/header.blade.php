        ...
        <div class="container header-hide-content pt-2">
            <div class="d-flex align-items-center">
                ...
                "hideOnScroll": "true"
                        ...
                        <img class="dropdown-item-icon mr-2" src="{{asset('frontend/assets/vendor/flag-icon-css/flags/4x3/us.svg')}}" alt="SVG">
                ...
                <div class="ml-auto">
                  ...
                  "hideOnScroll": "true"
                        ...
                        <div id="jumpToDropdown" class="hs-unfold-content dropdown-menu">
                            <a class="dropdown-item" href="faq.html">Help</a>
                            <a class="dropdown-item" href="contacts-agency.html">Contacts</a>
                        </div>
                    </div>
                    <!-- End Jump To -->
                ...
                <ul class="list-inline ml-2 mb-0">
                    ...
                    <li class="list-inline-item">
                        <div class="hs-unfold">
                            <a class="js-hs-unfold-invoker btn btn-icon btn-xs btn-ghost-secondary" href="javascript:;" data-hs-unfold-options='{
                        ...
                        <li class="hs-has-mega-menu navbar-nav-item">
                            ...
                            <div class="hs-mega-menu dropdown-menu w-100" aria-labelledby="homeMegaMenu">
                                <div class="row no-gutters">
                                    <div class="col-lg-6">
                                        <!-- Banner Image -->
                                        <div class="navbar-banner" style="background-image: url({{asset('frontend/assets/img/750x750/img1.jpg')}});">
