        ...
        <div class="form-row">
            <div class="col-12 mb-sm-3">
                <div class="js-form-message form-group">
                    ...
                    <input type="text" class="form-control" id="authorComment" value="{{Auth::user()->fullname}}">
                    </div>
                    <div class="js-form-message form-group">
                    ...
                    <div class="js-form-message form-group">
                        <label class="input-label">Nội dung: <em>(Vui lòng sử dụng tiếng Việt có dấu để tôn trọng người đọc)</em></label>
