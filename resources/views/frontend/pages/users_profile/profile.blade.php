            ...
            <div class="col-lg-9">
                ...
                <div class="card mb-3 mb-lg-5">
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-sm-9">
                                    <div class="media align-items-center">
                                        ...
                                        <div class="media-body">
                                            <div class="btn btn-sm btn-primary file-attachment-btn mb-2 mb-sm-0 mr-2">Tải ảnh lên
                                                <input type="file" class="js-file-attach file-attachment-btn-label" id="avatarUploader" data-hs-file-attach-options='{
                                    ...
                                    "targetAttr": "src"
                                            ...
                                            <a class="btn btn-sm btn-white mb-2 mb-sm-0" href="javascript:;">Xóa bỏ</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        "defaultCreated": 0
                                ...
                                <div class="col-sm-9">
                                    <div class="input-group align-items-center">
                                        <input type="text" class="js-masked-input form-control" name="phone" id="phoneLabel" placeholder="+x(xxx)xxx-xx-xx" aria-label="+x(xxx)xxx-xx-xx" value="+1(605)5618929" data-hs-mask-options='{
                           ...
                           "placeholder": "Type your message...",
                            ...
                            <!-- Form Group -->
                            <div class="row align-items-center">
                                <label for="disableAdCheckbox" class="col-sm-3 col-form-label input-label">Tắt quảng cáo <span class="badge badge-primary text-uppercase ml-1">PRO</span></label>

                                <div class="col-sm-9">
                                    <!-- Custom Checkbox -->
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" id="disableAdCheckbox">
                                        <label class="custom-control-label" for="disableAdCheckbox">Với tài khoản Pro của mình, bạn có thể vô hiệu hóa quảng cáo trên toàn bộ trang web.</label>
                                    </div>
                                    <!-- End Custom Checkbox -->
                                </div>
                            </div>
                    ...
                    <div class="card-footer d-flex justify-content-end">
                        ...
                        <a class="btn btn-primary" href="javascript:;">Lưu thay đổi</a>
                    </div>
                    <!-- End Footer -->
                </div>
                <!-- End Card -->
                ...
                <div id="editAddressCard" class="card mb-3 mb-lg-5">
                    ...
                    <div class="card-body">
                        <form>
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-sm-9">
                                    <!-- Select -->
                                    <div class="mb-3">
                                        <select class="js-custom-select" id="locationLabel" data-hs-select2-options='{
                                "customClass": "custom-select",
                                ...
                                "searchInputPlaceholder": "Search a country"
                                            ...
                                            <option value="MP" data-option-template='<span class="d-flex align-items-center"><img class="avatar avatar-xss avatar-circle mr-2" src="../../../../assets//vendor/flag-icon-css/flags/1x1/mp.svg" alt="Northern Mariana Islands Flag" /><span class="text-truncate">Northern Mariana Islands</span></span>'>Northern Mariana Islands</option>
                            ...
                            <!-- Form Group -->
                            <div class="row form-group">
                                <label for="addressLine1Label" class="col-sm-3 col-form-label input-label">Dòng địa chỉ 1</label>
                        ...
                        "defaultCreated": 0
                                ...
                                <label for="addressLine2Label" class="col-sm-3 col-form-label input-label">Dòng địa chỉ 2 <span class="input-label-secondary">(Tùy chọn)</span></label>
                            ...
                            <!-- Form Group -->
                            <div class="row form-group">
                                <label for="zipCodeLabel" class="col-sm-3 col-form-label input-label">Mã bưu chính <i class="far fa-question-circle text-body ml-1" data-toggle="tooltip" data-placement="top" title="You can find your code in a postal address."></i></label>
                        ...
                        <form>
                            ...
                            <div class="row form-group">
                                ...
                                "customClass": "custom-select"
                                            ...
                                            <option value="privacy1" data-option-template='<span class="media"><i class="fas fa-globe-americas text-body mt-1 mr-2"></i><span class="media-body"><span class="d-block">Anyone</span><small class="select2-custom-hide">Visible to anyone who can view your content. Accessible by installed apps.</small></span></span>'>Nất kì ai</option>
                                            <option value="privacy2" data-option-template='<span class="media"><i class="fas fa-user-lock text-body mt-1 mr-2"></i><span class="media-body"><span class="d-block">Only you</span><small class="select2-custom-hide">Only visible to you.</small></span></span>'>Chỉ có bạn</option>
                                        </select>
                                    </div>
                                    <!-- End Select -->
                                </div>
